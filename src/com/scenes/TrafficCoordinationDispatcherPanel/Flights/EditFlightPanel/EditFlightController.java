...
public class EditFlightController {
    ...
    public void submit() {
        try {
            ...
            ((Stage) dateTimePicker.getScene().getWindow()).close(); //Hard to update data, cause close the window
            ModalWindow.show("Success", "Flight has updated", ModalWindow.Icon.success);
        } catch (NoServerResponseException | ResponseException e) {
            ModalWindow.show("Error", e.getSuspendedMessage() + "\nFlight has not updated", ModalWindow.Icon.error);
        }
    }
